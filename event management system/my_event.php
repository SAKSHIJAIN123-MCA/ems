...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<tr><td>" . $row['etype'] . "</td><td>" . $row['eattendees'] . "</td><td>" . $row['dvenue'] . "</td><td><font color=$color>$status</font></td><td>" . $row['date'] . "</td><td><a href='my_eventdelete.php?id=" . $row['id'] . "' onclick='return conf()'>Cancel Booking</a></td></tr>";
}
?>
