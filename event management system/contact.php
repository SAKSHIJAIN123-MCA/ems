...
<div id="main">
<ul>
  		<li><a href="contact.php">Book-Event</a></li>
     	<li><a href="my_event.php">My Events</a></li>
       <li><a href="http://localhost/ems/event%20management%20system/feedback.php">Feedback</a></li>
       <li><a href="http://localhost/ems/event%20management%20system/index.php">Logout</a></li>
...
<option value="1">Adolphus Busch Hall</option>
<option value="2">Adolphus Busch Hall and Garden</option>
<option value="3">Arthur M. Sackler Museum</option>
<option value="4">Cambridge Queen's Head pub</option>
<option value="5">Center for European Studies</option>
<option value="6">CGIS</option>
<option value="7">Fay House</option>
<option value="8">Harvard Faculty Club</option>
<option value="9">Harvard Football Tailgating</option>
<option value="10">Harvard Information Center</option>
<option value="11">Museum of Natural History</option>
<option value="12">Hillel House</option>
<option value="13">Loeb House</option>
<option value="14">Memorial Church</option>
<option value="15">Memorial Hall</option>
<option value="16">Northwest Building</option>
<option value="17">Peabody Museum of Archaeology &amp; Ethnology</option>
<option value="18">Radcliffe Yard</option>
<option value="19">The Plaza Tent</option>
<option value="20">The Science Center</option>
</select>
</div>
<div id="cost">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('register-form').addEventListener('submit', function(event) {
        ...
        if (selectedDate < minDate || selectedDate > maxDate) {
            alert('Please select a date after ' + minDate.toLocaleDateString()  + '.');
